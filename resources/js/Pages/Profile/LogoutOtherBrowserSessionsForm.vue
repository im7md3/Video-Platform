    ...
    <jet-action-section>
        ...
        <template #content>
            ...
            <div class="mt-5 space-y-6" v-if="sessions.length > 0">
                <div class="flex items-center" v-for="(session, i) in sessions" :key="i">
                    <div>
                        ...
                        <svg xmrns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" class="w-8 h-8 text-gray-500" v-else>
                    ...
                    <div class="mr-3">
                        ...
                        <div>
                            <div class="text-xs text-gray-500">
                                ...
                                <span v-else>{{ __('last_avtive') }} {{ session.last_active }}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex items-center mt-5">
                <jet-button @click="confirmrogout">
                    {{ __('session_logout') }}
                </jet-button>
